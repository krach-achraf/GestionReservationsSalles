...
<body>
	...
	<div class="all-content-wrapper">
		...
		<div class="header-advance-area">
			...
			<div class="breadcome-area">
				<%@include file="template/breadcomes/sallesForm.jsp"%>
			</div>
		</div>
						...
						<div class="product-status-wrap drp-lst">
							...
							<div class="add-product">
								<a class="Primary mg-b-10" href="#" data-toggle="modal"
									data-target="#PrimaryModalalert">Ajouter salle</a>
							</div>
							<div class="asset-inner">
								<%@include file="forms/listes/liste-salles.jsp"%> <!-- liste salles -->
							</div>
						</div>
					</div>
				</div>
		...
		<%@include file="forms/formulaires/form-salles.jsp"%> <!-- formulaire de gestion dans modal -->
		<!-- fin main -->
	...
	<script src="script/gestion-salles.js"></script>
</body>
		</html>
	</c:when>
	<c:otherwise>
